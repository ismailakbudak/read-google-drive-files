...
class Ui_MainWindow(object):
    ...
    def read(self):
        ...
        for response in result:
            ...
            if int(response['quotaBytesUsed']) > 0 :
                datas.append('Title : ' + response['title'])
                datas.append('Size : ' + response['quotaBytesUsed'])
                datas.append('Download : ' + response['webContentLink'])
    ...
    def upload(self):
        ...
        datas = [
           ...
           'Size : ' + response['quotaBytesUsed'],
           'Download : ' + response['webContentLink']
        ]
